...
// this function needs to be adapted, if a malloc fails in the middle the rest
// of the tree isnt allocated so it should be freed alone 
// readapt allocate_gc to not exit version and return fail free the collected so far
// and free tree and exit.
